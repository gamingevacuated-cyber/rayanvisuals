...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Rayan is a professional video editor with 7+ years of experience in gaming, shorts, reels, and long-form content. Premiere Pro & After Effects specialist." },
      { name: "author", content: "Rayan" },
      { property: "og:title", content: "Rayan — Professional Video Editor | 7 Years Experience" },
      { property: "og:description", content: "Rayan is a professional video editor with 7+ years of experience in gaming, shorts, reels, and long-form content. Premiere Pro & After Effects specialist." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700;800;900&family=Inter:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap" },
